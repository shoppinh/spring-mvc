...
<div class="da-projects" id="projects">
  <div class="row mx-0">
    <div class="col-md-6 px-0 da-project-1" style="background-image: url('<c:url value="/template/web/images/da-img-2.jpg"/>');" data-aos="zoom-in"></div>
  ...
  <div class="row mx-0">
    ...
    <div class="col-md-6 px-0 da-project-2" style="background-image: url('<c:url value="/template/web/images/da-img-5.jpg"/>');" data-aos="zoom-in"></div>
  </div>
</div>
<div class="da-expertise">
  <div class="row mx-0">
    <div class="col-md-6 px-0 da-exp-image" style="background-image: url('<c:url value="/template/web/images/da-img-6.jpg"/>');" data-aos="zoom-in"></div>
          ...
          <c:forEach var="item" items="${NhanVien.listResult}" begin="0" end="2" >
              ...
              <div class="card d-block mb-3"><img class="card-img-top" src="<c:url value="/template/web/images/${item.avatar}"/>" alt="image"/>
                <div class="card-body text-center">
                  <div class="h5">${item.tenNV}</div>
                  <p class="text-muted">${item.chucVu}</p>
                </div>
              </div>
            </div>
          </c:forEach>
...
<div class="container da-gallery" id="gallery">
  ...
  <div class="card-columns">
    <div class="card"><a href="<c:url value="/template/web/images/gallery-img-3.jpg"/>" data-toggle="lightbox" data-gallery="da-gallery"><img class="img-fluid" src="<c:url value="/template/web/images/gallery-img-3.jpg"/>" alt="Gallery Image 1"/></a></div>
    <div class="card"><a href="<c:url value="/template/web/images/gallery-img-5.jpg"/>" data-toggle="lightbox" data-gallery="da-gallery"><img class="img-fluid" src="<c:url value="/template/web/images/gallery-img-5.jpg"/>" alt="Gallery Image 2"/></a></div>
    <div class="card"><a href="<c:url value="/template/web/images/gallery-img-4.jpg"/>" data-toggle="lightbox" data-gallery="da-gallery"><img class="img-fluid" src="<c:url value="/template/web/images/gallery-img-4.jpg"/>" alt="Gallery Image 3"/></a></div>
    <div class="card"><a href="<c:url value="/template/web/images/gallery-img-1.jpg"/>" data-toggle="lightbox" data-gallery="da-gallery"><img class="img-fluid" src="<c:url value="/template/web/images/gallery-img-1.jpg"/>" alt="Gallery Image 4"/></a></div>
    <div class="card"><a href="<c:url value="/template/web/images/gallery-img-2.jpg"/>" data-toggle="lightbox" data-gallery="da-gallery"><img class="img-fluid" src="<c:url value="/template/web/images/gallery-img-2.jpg"/>" alt="Gallery Image 5"/></a></div>
  </div>
</div>
<div class="da-section">
  <div class="container da-company-brand py-5">
    ...
    <div class="row">
      <div class="col-md-3 text-center"><img class="img-fluid" src="<c:url value="/template/web/images/company-1.jpg"/>" alt="Company Image 1"/></div>
      <div class="col-md-3 text-center"><img class="img-fluid" src="<c:url value="/template/web/images/company-2.jpg"/>" alt="Company Image 2"/></div>
      <div class="col-md-3 text-center"><img class="img-fluid" src="<c:url value="/template/web/images/company-3.jpg"/>" alt="Company Image 3"/></div>
      <div class="col-md-3 text-center"><img class="img-fluid" src="<c:url value="/template/web/images/company-4.jpg"/>" alt="Company Image 4"/></div>
    </div>
  </div>
</div>
